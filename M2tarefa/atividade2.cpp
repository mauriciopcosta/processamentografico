...
int main()
{
    ...
    // Cria e armazena VAOs de 5 triângulos diferentes
    vector<GLuint> VAOs;
    VAOs.push_back(createTriangle(-0.8f, -0.4f, -0.6f, -0.4f, -0.7f, -0.2f));
    VAOs.push_back(createTriangle(-0.4f, -0.4f, -0.2f, -0.4f, -0.3f, -0.2f));
    VAOs.push_back(createTriangle( 0.0f, -0.4f,  0.2f, -0.4f,  0.1f, -0.2f));
    VAOs.push_back(createTriangle( 0.4f, -0.4f,  0.6f, -0.4f,  0.5f, -0.2f));
    VAOs.push_back(createTriangle(-0.2f,  0.1f,  0.0f,  0.1f, -0.1f,  0.3f));
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // Desenha os 5 triângulos armazenados no vetor
        for (GLuint vao : VAOs)
        {
